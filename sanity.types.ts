...
// Query: *[_type == "course" && slug.current == $slug][0] {    _id,    title,    "slug": slug.current,    summary,    level,    price,    popular,    studentCount,    coverImage {  asset,  alt,  crop,  hotspot},    learningOutcomes[]{_key, icon, title, description},    instructor->{_id, name, "slug": slug.current, photo {  asset,  alt,  crop,  hotspot}, expertise, bio},    category->{title, "slug": slug.current, description},    modules[]{      _key,      title,      summary,      lessons[]->{  _id,  _key,  title,  "slug": slug.current,  duration,  freePreview,  thumbnail {  asset,  alt,  crop,  hotspot}}    }  }
...
// Query: *[_type == "instructor" && slug.current == $slug][0] {    _id,    name,    "slug": slug.current,    photo {  asset,  alt,  crop,  hotspot},    expertise,    bio,    "courses": *[_type == "course" && instructor._ref == ^._id] | order(title asc) {      _id,      title,      "slug": slug.current,      summary,      level,      price,      coverImage {  asset,  alt,  crop,  hotspot},      "moduleCount": count(modules),      "totalDuration": math::sum(modules[].lessons[]->duration)    }  }
